...
var Player2;
var Player2_win,Player2_win_still;
...
function preload() {
  ...
  Player1_RS_crouch_still = loadAnimation("Images/Player1/Right/Crouch/2.png"); Player1_LS_anim_norm = loadAnimation("Images/Player1/Left/Norm/0.png","Images/Player1/Left/Norm/1.png",
 ...
 Player2_RS_anim_crouch = loadAnimation("Images/Player2/Right/Crouch/0.png","Images/Player2/Right/Crouch/1.png",
  ...
  Player2_RS_crouch_still = loadAnimation("Images/Player2/Right/Crouch/2.png"); Player2_LS_anim_norm = loadAnimation("Images/Player1/Left/Norm/0.png","Images/Player1/Left/Norm/1.png",
  ...
  "Images/Player2/Left/Norm/8.png","Images/Player2/Left/Norm/9.png");
  ...
  Player2_LS_lose_still = loadAnimation("Images/Lose/Player2/Left/8.png");
...
function setup() {
  ...
  // Player 2
 Player2 = createSprite(400, windowHeight-40, 50, 50);
 Player2 .addAnimation("win1",Player2_win);
 Player2.addAnimation("win1_still",Player2_win_still);
     // Left Side
     Player2.addAnimation("Normal_LS_1",Player2_LS_anim_norm);
     Player2.addAnimation("right_LS_1",Player2_LS_anim_move_right);
     Player2.addAnimation("left_LS_1",Player2_LS_anim_move_left);
     Player2.addAnimation("jump_LS_1",Player2_LS_anim_jump);
     Player2.addAnimation("punch_LS_1",Player2_LS_anim_punch);
     Player2.addAnimation("kick_LS_1",Player2_LS_anim_kick);
     Player2.addAnimation("crouch_LS_1",Player2_LS_anim_crouch);
     Player2.addAnimation("crouch_still_LS_1",Player2_LS_crouch_still);
     Player2.addAnimation("block_LS_still_1",Player2_LS_block_still);
     Player2.addAnimation("lose_LS_still_1",Player2_LS_lose_still);
     // Right Side
     Player2.addAnimation("Normal_RS_1",Player2_RS_anim_norm);
     Player2.addAnimation("right_RS_1",Player2_RS_anim_move_right);
     Player2.addAnimation("left_RS_1",Player2_RS_anim_move_left);
     Player2.addAnimation("jump_RS_1",Player2_RS_anim_jump);
     Player2.addAnimation("punch_RS_1",Player2_RS_anim_punch);
     Player2.addAnimation("kick_RS_1",Player2_RS_anim_kick);
     Player2.addAnimation("crouch_RS_1",Player2_RS_anim_crouch);
     Player2.addAnimation("crouch_still_RS_1",Player2_RS_crouch_still);
     Player2.addAnimation("block_RS_still_1",Player2_RS_block_still);
     Player2.addAnimation("lose_RS_still_1",Player2_RS_lose_still);
 Player2.scale = 2;  
  ...
  Lbtn2 = createSprite(50,windowHeight-150,50,50);
  Lbtn2.addImage(LImg2);
  Lbtn2.scale = 0.3;

  Rbtn2 = createSprite(150,windowHeight-150,50,50);
  Rbtn2.addImage(RImg2);
  Rbtn2.scale = 0.3;

  UPbtn2 = createSprite(100,windowHeight-200,50,50);
  UPbtn2.addImage(UImg2);
  UPbtn2.scale = 0.3;

  DWbtn2 = createSprite(100,windowHeight-100,50,50);
  DWbtn2.addImage(DImg2);
  DWbtn2.scale = 0.3;

  punch2 = createSprite(45,windowHeight-225,50,50);
  punch2.addImage(punchImg2);

  kick2 = createSprite(175,windowHeight-75,50,50);
  kick2.addImage(kickImg2);

  block2 = createSprite(55,windowHeight-50,50,50);
